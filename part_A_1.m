...
%% Computing STD and plotting the brain waves in the different segments
...
% Plotting the the different waves in time domain - segment 2
figure;
...
% Plotting the the different waves in frequency domain - segment 2
figure;
subplot(2,2,1)    
